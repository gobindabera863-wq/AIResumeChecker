...
const SOCIAL_LINKS = [
  {
    name: "GitHub",
    icon: GithubIcon,
    href: "https://github.com/gobindabera863-wq?tab=repositories",
  },
  {
    name: "LinkedIn",
    icon: LinkedinIcon,
    href: "https://www.linkedin.com/in/gobindabera",
  },
];
...
const COLUMNS = [
  ...
  },
  {
    title: "Connect",
    links: [
      { label: "GitHub Repositories", href: "https://github.com/gobindabera863-wq?tab=repositories", external: true },
      { label: "LinkedIn Profile", href: "https://www.linkedin.com/in/gobindabera", external: true },
    ],
  },
  {
    title: "Resources",
            ...
            <div className="flex items-center gap-2.5 mt-5">
              {SOCIAL_LINKS.map((item) => (
                <a
                  ...
                  className="h-9 w-9 rounded-full bg-[var(--surface-2)] border border-[var(--border)] hover:bg-emerald-500/15 text-[var(--ink-muted)] hover:text-emerald-600 dark:hover:text-emerald-400 flex items-center justify-center transition-all shadow-sm hover:scale-105"
                >
                  <item.icon />
                </a>
              ))}
                ...
                {col.links.map((l) => (
                  <li key={l.label}>
                    <a
                      ...
                      className="text-[13px] text-[var(--ink-muted)] hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors"
                    >
                      {l.label}
                    </a>
                  </li>
